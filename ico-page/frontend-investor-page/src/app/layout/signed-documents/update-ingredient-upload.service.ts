...
@Injectable()
export class UpdateIngredientUploadService {
    ...
    public putItemUpdate(itemData: Ingredient): Observable<HttpResponse<Object>> {
        const urlString = UpdateIngredientUploadService.URL_INGREDIENT;
        return this.putDataToURL(urlString, itemData);
    }

    private putDataToURL(partUrl: string, itemData: Ingredient): Observable<any> {
